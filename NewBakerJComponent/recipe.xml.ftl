...
<recipe>
    ...
    <mkdir at="${projectOut}/src/main/java/component" />
    ...
    <instantiate from="root/DebugAndroidManifest.xml.ftl"
                   to="${escapeXmlAttribute(manifestOut)}/component/AndroidManifest.xml" />
    ...
    <instantiate from="root/src/app_package/App.java.ftl"
                   to="${projectOut}/src/main/java/component/App.java" />
    <instantiate from="root/src/app_package/LaunchActivity.java.ftl"
                   to="${projectOut}/src/main/java/component/LaunchActivity.java" />
    <instantiate from="root/gradle.properties.ftl"
                   to="${projectOut}/gradle.properties" />
